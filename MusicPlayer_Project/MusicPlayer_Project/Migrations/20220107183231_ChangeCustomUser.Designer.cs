...
{
    [DbContext(typeof(MusicPlayer_ProjectContext))]
    [Migration("20220107183231_ChangeCustomUser")]
    partial class ChangeCustomUser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("webApp")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicPlayer_Project.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicPlayer_Project.Models.Album", b =>
                {
                    b.HasOne("MusicPlayer_Project.Models.Artist", "Artist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("MusicPlayer_Project.Models.AlbumGenre", b =>
                {
                    b.HasOne("MusicPlayer_Project.Models.Album", "Album")
                        .WithMany("AlbumGenres")
                        .HasForeignKey("AlbumID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicPlayer_Project.Models.Genre", "Genre")
                        .WithMany("AlbumGenres")
            ...
            modelBuilder.Entity("MusicPlayer_Project.Models.ArtistSong", b =>
                {
                    ...
                    b.HasOne("MusicPlayer_Project.Models.Song", "Song")
                        .WithMany("ArtistSongs")
            ...
            modelBuilder.Entity("MusicPlayer_Project.Models.PlaylistCollection", b =>
                {
                    b.HasOne("MusicPlayer_Project.Models.Playlist", "Playlist")
                        .WithMany("PlaylistCollection")
            ...
            modelBuilder.Entity("MusicPlayer_Project.Models.PlaylistUser", b =>
                {
                    b.HasOne("MusicPlayer_Project.Models.Playlist", "Playlist")
                        .WithOne("PlaylistUser")
                        .HasForeignKey("MusicPlayer_Project.Models.PlaylistUser", "PlaylistID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicPlayer_Project.Models.User", "User")
